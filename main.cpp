...
int main(){
    ...
    // DynamicArray<std::string> array = DynamicArray<std::string>();
    ...
    // array.pop();
    // std::cout << array << std::endl;
    // DynamicArray<double> arrayDoubles = DynamicArray<double>();
    // DynamicArray<int> array = DynamicArray<int>(20,10);
    DynamicArray<int> array = DynamicArray<int>(20,10);
    array[0] = 4;
    array[9] = 90;
    std::cout << array << std::endl;

    DynamicArray<std::string> stringArray = DynamicArray<std::string>(20,10);
    stringArray[0] = "Hello";
